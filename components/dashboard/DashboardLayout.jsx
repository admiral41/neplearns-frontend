        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <header className="sticky top-0 z-10 flex items-center justify-between px-4 py-3 border-b bg-background">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-muted-foreground italic">Keep learning, keep growing</p>
            </div>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-56">
                    ...
                    <DropdownMenuItem asChild>
                      <Link href="/student-dashboard/profile" className="cursor-pointer">
                        <User className="mr-2 h-4 w-4" />
                        Profile
                      </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                      <Link href="/student-dashboard/settings" className="cursor-pointer">
